...
namespace yii\easyii\modules\rbac\components;
 ...
 * 
 * ```
 * Yii::$container->set('yii\easyii\modules\rbac\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
class Configs extends \yii\base\Object
{
     ...
     */
    public $menuTable = '{{%easyii_menus}}';

    /**
     * @var string Menu table name.
     */
    public $userTable = '{{%easyii_users}}';
